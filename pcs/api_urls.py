...
from .api_views import (
    ...
    prod_request_compose, prod_request_priority, questionnaire_priority,
    campaigns_status,
    physics_configs_requestors,
    validation_v1_index,
...
urlpatterns = [
    ...
    path('requests/<int:pk>/priority/', prod_request_priority,
         name='prod_request_priority'),
    path('questionnaires/<int:pk>/priority/', questionnaire_priority,
         name='questionnaire_priority'),
