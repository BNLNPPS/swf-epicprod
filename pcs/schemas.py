...
TAG_SCHEMAS = {
    'p': {
        ...
        'optional': [
            ...
            'decay_mode', 'hadron_charge', 'helicity', 'polarization',
            'beam_polarization', 'coherence',
        ...
        'choices': {
            ...
            'beam_energy_electron': ['5', '9', '10', '18', 'N/A'],
            ...
            'beam_polarization': ['eMinus-pPlus', 'eMinus-pMinus'],
            'coherence': ['coherent'],
            'model': ['bsat'],
